...
### [1. Python Scripts](https://github.com/reka-ai/clip-api-examples/blob/main/python/README.md)
...
### [2. Node.js Scripts](https://github.com/reka-ai/clip-api-examples/blob/main/javascript/README.md)

Node.js scripts mirroring the Python functionality. Requires Node.js 18+ (uses native fetch). Includes a clip generator with streaming progress and a status checker. 👉 [All Node.js details here](https://github.com/reka-ai/clip-api-examples/blob/main/javascript/README.md) 👈

### [3. C# Scripts](https://github.com/reka-ai/clip-api-examples/blob/main/dotnet/README.md)

C# file-based programs (single `.cs` files without project files). Requires .NET 10.0 or later. Includes a clip generator with streaming progress and a status checker. 👉 [All C# details here](https://github.com/reka-ai/clip-api-examples/blob/main/dotnet/README.md) 👈

### [4. n8n Workflows](https://github.com/reka-ai/clip-api-examples/blob/main/n8n/README.md)

n8n is an integration and automation platform perfect for less technical users as it uses less code or even no code. Explore our templates to get clips generated automatically from YouTube videos. 👉 [All n8n details here](https://github.com/reka-ai/clip-api-examples/blob/main/n8n/README.md) 👈
